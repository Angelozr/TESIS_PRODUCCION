...
const { authRequired, adminRequired } = require('./authMiddleware.js');
...
app.get("/api/usuarios", adminRequired, async (req, res) => {
  try {
...
app.delete("/api/usuarios/:id",adminRequired, async (req, res) => {
  const { id } = req.params;
  try {
...
app.get('/api/profile', authRequired, async (req, res) => {
  try {
    // Ahora ya tienes req.user disponible gracias al middleware
    const result = await pool.query(
      'SELECT nombre, apellido, email FROM usuarios WHERE id = $1',
      [req.user.id] // <-- El ID viene del JWT ya validado
    );
...
app.get('/api/lugar',adminRequired, async (req, res) => {
...
// Agregar un lugar
app.post('/api/lugar', adminRequired,async (req, res) => {
  try {
...
// Modificar lugar
app.put('/api/lugar/:id', adminRequired,async (req, res) => {
  const { id } = req.params;
  const { nombre, fecha_creacion } = req.body;
...
// Eliminar lugar
app.delete('/api/lugar/:id',adminRequired, async (req, res) => {
  const { id } = req.params;
...
app.get('/api/categorias', adminRequired, async (req, res) => {
  try {
...
app.get('/api/categorias/lugar', adminRequired, async (req, res) => {
...
app.post('/api/categorias', adminRequired, async (req, res) => {
  try {
...
app.put('/api/categorias/:id',adminRequired,  async (req, res) => {
  const { id } = req.params;
  const { nombre } = req.body;
...
app.delete('/api/categorias/:id', adminRequired, async (req, res) => {
  const { id } = req.params;
...
app.get('/api/edificios', adminRequired, async (req, res) => {
...
app.post('/api/edificios', adminRequired, async (req, res) => {
  try {
...
app.put('/api/edificios/:id', adminRequired, async (req, res) => {
  const { id } = req.params;
  const { nombre, lugar_id, categoria_id } = req.body;
...
app.delete('/api/edificios/:id',adminRequired, async (req, res) => {
  const { id } = req.params;
...
app.get('/api/laboratorios',adminRequired, async (req, res) => {
...
app.get('/api/bloques/:id',adminRequired, async (req, res) => {
...
app.get('/api/bloques',adminRequired, async (req, res) => {
...
// Agregar un bloque
app.post('/api/bloques',adminRequired, async (req, res) => {
  try {
...
// Modificar un bloque
app.put('/api/bloques/:id', adminRequired, async (req, res) => {
  const { id } = req.params;
...
// Eliminar un bloque
app.delete('/api/bloques/:id',adminRequired, async (req, res) => {
  const { id } = req.params;
...
app.get('/api/evaluaciones', authRequired, async (req, res) => {
  try {
    const query = `
      SELECT 
          e.id,
...
app.get('/api/bloques/:id',authRequired, async (req, res) => {
  const bloqueId = req.params.id;
  try {
    const query = `
      SELECT 
...
app.post('/api/evaluaciones',adminRequired, async (req, res) => {
  const {
    nombre,
    lugar_id,
    categoria_id,
...
app.put('/api/evaluaciones/:id',authRequired, async (req, res) => {
  const { id } = req.params;
...
// Eliminar evaluación
app.delete('/api/evaluaciones/:id',authRequired, async (req, res) => {
  const { id } = req.params;
